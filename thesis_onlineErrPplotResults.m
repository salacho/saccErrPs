function onlineRes = thesis_onlineErrPplotResults
...
load('C:\Users\salacho\Documents\Data\saccErrPs\onlineSessionsErrPs&SaccDcd-data.mat');
maxSess = size(onlineRes,2);
minSess = 10;
subjects = {'chico','jonah'};
maxSubj = length(subjects);
...
hLeg = legend(legendTxt,'location','SouthWest','FontSize',plotInfo.titleFontSize-2);
...
hLeg = legend(legendTxt,'location','best');
set(hLeg,'box','off') 
