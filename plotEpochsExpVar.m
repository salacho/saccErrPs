...
xlabel('Time from positive/negative reinforcement onset [ms]','FontSize',plotParams.axisFontSize+2,'FontWeight',plotParams.axisFontWeight)
ylabel('Electrode #','FontSize',plotParams.axisFontSize+2,'FontWeight',plotParams.axisFontWeight)

% Title
title(sprintf('%s Epochs Explained Variance for all channels and arrays',ErrorInfo.session),'FontSize',plotParams.titleFontSize,'FontWeight',plotParams.titleFontWeight)
...
legend(legPlots,{'PFC','SEF','FEF'},'location','best')                  % legends
