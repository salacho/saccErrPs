...
title(sprintf('%s:  ErrDiff-prePostDiff Cross-Freq. Amp-Amp. Coupling PFCSEFFEF',ErrorInfo.session),'fontweight','bold','fontsize',13);
saveplotName = sprintf('%s-%s',fullfile(ErrorInfo.dirs.DataOut,'popAnalysis',...
ErrorInfo.session),'ErrDiff-prePostDiff-Fdback-CrossFreqAmpCoupling-PFCSEFFEF.png');
